...
function generateQueueEmbed(client, guildId, leave){
    ...
    var stopbutton = new MessageButton().setStyle('DANGER').setCustomId('Stop').setEmoji(`<:emoji_23:1006271268519170168>`).setLabel(`Stop`).setDisabled()
    ...
    var pausebutton = new MessageButton().setStyle('SECONDARY').setCustomId('Pause').setEmoji('<:emoji_16:1006255536913793184>').setLabel(`Pause`).setDisabled();
